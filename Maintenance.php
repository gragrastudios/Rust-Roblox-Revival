  ...
  .content p {  font-family: Comic Sans MS,Geneva,Arial,Helvetica,sans-serif;
    ...
    <div align="center"> 
        ...
        <div class="content"> 
            <h1> 
                We are upgrading RUST!<br> 
                Stay tuned... We'll be back online soon.
            </h1> 
            <h2> 
                You will be redirected to RUST when we are back up.</h2> 
            <p> 
...
window.window.setTimeout("window.location = '/'", 30000);
    </script> 
